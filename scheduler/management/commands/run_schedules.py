...
PUBLISH_FACEBOOK_REEL_ENDPOINT = "https://social-ai-s1kk.onrender.com/publish-facebook-reel/"
PUBLISH_INSTAGRAM_POST_ENDPOINT = "https://social-ai-s1kk.onrender.com/publish-instagram-post/"
PUBLISH_INSTAGRAM_REEL_ENDPOINT = "https://social-ai-s1kk.onrender.com/publish-instagram-reel/"
REPLY_INSTAGRAM_COMMENTS_ENDPOINT = "https://social-ai-s1kk.onrender.com/reply-instagram-reel-comments/"
        ...
        for schedule in schedules:
            ...
            try:
                ...
                if social_media == 'instagram' and channel == 'reel':
                    ...
                    response = requests.post(url=PUBLISH_INSTAGRAM_REEL_ENDPOINT, json=json)
                ...
                if social_media == 'instagram' and channel == 'post':
                    ...
                    response = requests.post(url=PUBLISH_INSTAGRAM_POST_ENDPOINT, json=json)
                    logger.info(f"RESPONSE: {response.reason}")
                    ...
                    response = requests.post(url=PUBLISH_FACEBOOK_REEL_ENDPOINT, json=json)
                    logger.info(f"RESPONSE: {response.reason}")
